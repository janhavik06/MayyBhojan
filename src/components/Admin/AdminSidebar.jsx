...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-white flex flex-col shadow-md shadow-black/5 justify-between fixed left-0 top-18 h-225 ">
      ...
      <div className="p-5 space-y-2">
        ...
        <NavLink to="/admin/approvals" className={({ isActive }) => `${item} ${isActive ? active : ""}`}>
        <i class="fa-solid fa-check"></i> Approvals
        </NavLink>

        <NavLink to="/admin/safety" className={({ isActive }) => `${item} ${isActive ? active : ""}`}>

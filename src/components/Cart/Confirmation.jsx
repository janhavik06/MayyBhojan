...
//   return (
//     <div className="min-h-screen bg-[#F7F4F1] pb-16">
//       {/* ARIA status */}
...
//           {/* DELIVERY PARTNER */}
//           <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6 flex justify-between items-center">
...
//               <button className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 transition text-white px-6 py-3 rounded-xl font-medium">
//                 <FaPhoneAlt />
//                 Call Rahul
//               </button>

//               <button className="flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-6 py-3 rounded-xl font-medium">
//                 <FaCommentDots />
//                 Chat
//               </button>
//             </div>
...
//             <button className="mt-4 underline text-sm text-gray-600 hover:text-orange-500">
//               View Full Receipt
//             </button>
//           </div>

//           {/* SAFETY CARD */}
//           <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-sm">
...
//         <button className="flex items-center gap-2 border border-gray-300 hover:bg-gray-100 px-8 py-4 rounded-xl text-lg font-medium">
//           <FaRedoAlt />
//           Reorder This Meal
//         </button>

//         <button className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 px-8 py-4 rounded-xl text-lg font-medium">
//           <FaHeadset />
//           Get Help & Support
//         </button>
//       </div>

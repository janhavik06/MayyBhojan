...
//   return (
//     <div className="min-h-screen bg-[#F6F2EF] relative">
//       {/* SUCCESS POPUP */}
//       {showSuccess && (
//         <>
...
//             { id: "upi", title: "UPI / Apps" },
//             { id: "cod", title: "Cash on Delivery" },
//           ].map((m) => (
//             <div
//               key={m.id}
//               onClick={() => setMethod(m.id)}
//               className={`p-5 rounded-2xl border cursor-pointer mb-3
//               ${
//                 method === m.id
//                   ? "border-orange-400 bg-orange-50"
//                   : "border-gray-200"
...
//             className="w-full mt-6 bg-orange-500 text-white py-4 rounded-xl font-semibold hover:bg-orange-600"
//           >
//             Confirm Payment
//           </button>
//         </div>
